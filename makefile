...
MANAGERFILES = $(MANAGERPATH)MainConsole.java $(MANAGERPATH)AddProductController.java $(MANAGERPATH)AddProductModel.java $(MANAGERPATH)AddProductView.java $(MANAGERPATH)ProductDetailView.java $(MANAGERPATH)ProductDetailModel.java $(MANAGERPATH)ProductDetailController.java $(MANAGERPATH)StockModel.java $(MANAGERPATH)StockView.java $(MANAGERPATH)StockController.java
